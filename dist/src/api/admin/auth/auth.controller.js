...
let AuthController = class AuthController {
    ...
    async login(dto) {
        try {
            ...
            return new api_response_1.default("Admin login successfully", common_1.HttpStatus.OK, data);
        }
        catch (error) {
    ...
    async logout(user) {
        try {
            ...
            return new api_response_1.default("Admin logout successfully", common_1.HttpStatus.OK);
        }
        catch (error) {
            throw error instanceof common_1.HttpException
                ? error
