...
exports.CustomerModule = CustomerModule = __decorate([
    (0, common_1.Module)({
        imports: [file_module_1.FilesModule],
        controllers: [customer_controller_1.CustomerController],
        providers: [customer_service_1.CustomerService, prisma_service_1.PrismaService, pagination_util_1.PaginationService, jwt_1.JwtService, file_service_1.FilesService],
