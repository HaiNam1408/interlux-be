...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 100, description: 'Sort order (lower values appear first)', required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 1, description: 'Parent category ID', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    (0, class_transformer_1.Transform)(({ value }) => value ? parseInt(value) : undefined),
    __metadata("design:type", Number)
