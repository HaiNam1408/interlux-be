...
exports.seedProductAttributes = seedProductAttributes;
const slugify_1 = require("./utils/slugify");
async function seedProductAttributes(prisma) {
        ...
        for (const color of colorValues) {
            await prisma.productAttributeValue.create({
                data: {
                    ...
                    name: color.name,
                    slug: (0, slugify_1.slugify)(color.name),
                    value: color.value,
                    sort: 1,
                    status: 'ACTIVE',
                },
        ...
        for (const material of materialValues) {
            await prisma.productAttributeValue.create({
                data: {
                    ...
                    name: material.name,
                    slug: (0, slugify_1.slugify)(material.name),
        ...
        for (const size of sizeValues) {
            await prisma.productAttributeValue.create({
                data: {
                    ...
                    name: size.name,
                    slug: (0, slugify_1.slugify)(size.name),
                    value: size.value,
                    sort: 1,
                    status: 'ACTIVE',
                },
...
//# sourceMappingURL=03-product-attributes.js.map